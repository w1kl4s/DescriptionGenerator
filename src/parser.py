...
class HashParser:
    ...
    def parse_directory(self, log):
        ...
        for count, file_path in enumerate(self.file_paths):
            log.info("File {} out of {}: ".format(count + 1, len(self.file_paths)) + self.filenames[count])
